...
class App {
  ...
  _newWorkout(e) {
    const validInputs = (...inputs) =>
      inputs.every(inp => Number.isFinite(inp) && inp > 0); // TUTAJ JEST ZROBIONE INACZEJ NIŻ W KURSIE (SEKCJA NEW WORKOUT MINUTA 17:28)
    e.preventDefault();
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Imputs have to be postive numbers');
